...
public class DragonPoisonDebuff extends Buff
{
    ...
    {
        buff.setModifier(BuffModifiers.POISON_DAMAGE_FLAT, this.fireDamage.getValue(buff.getUpgradeTier()));
