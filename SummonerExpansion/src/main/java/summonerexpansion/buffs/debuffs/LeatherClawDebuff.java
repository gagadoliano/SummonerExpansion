...
public class LeatherClawDebuff extends Buff
{
    public LeatherClawDebuff()
    {
        canCancel = false;
        isImportant = true;
    }
    ...
    public void onWasHit(ActiveBuff buff, MobWasHitEvent event)
    {
        ...
        if (buff.owner.buffManager.getStacks(this) >= 5)
        {
            ...
            {
                buff.owner.addBuff(new ActiveBuff(SummonerBuffs.SummonerDebuffs.SUMMON_GENERIC_WEAKNESS, buff.owner, 10F, event.target), true);
