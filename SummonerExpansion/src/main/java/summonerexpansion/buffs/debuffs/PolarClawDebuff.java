...
public class PolarClawDebuff extends Buff
{
    public PolarClawDebuff()
    {
        canCancel = false;
        isImportant = true;
    }
    ...
    public void onWasHit(ActiveBuff buff, MobWasHitEvent event)
    {
        ...
        if (buff.owner.buffManager.getStacks(this) >= 5)
        {
            ...
            {
                buff.owner.addBuff(new ActiveBuff(BuffRegistry.Debuffs.GENERIC_ICE_SLOW, buff.owner, 10F, event.target), true);
