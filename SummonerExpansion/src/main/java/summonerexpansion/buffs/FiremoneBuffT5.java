...
public class FiremoneBuffT5 extends Buff
{
    public FiremoneBuffT5()
    {
        canCancel = false;
        shouldSave = false;
        isImportant = true;
    ...
    {
        activeBuff.setModifier(BuffModifiers.ARMOR_PEN_FLAT, 50);
        activeBuff.setModifier(BuffModifiers.PROJECTILE_VELOCITY, 0.50F);
    }
