...
import static summonerexpansion.codes.registries.RegistryBuffs.WeaponBuffs.APPLEWALKBUFF;
...
public class AppleWalkProj extends FollowingProjectile
{
    ...
    public void onHit(Mob mob, LevelObjectHit object, float x, float y, boolean fromPacket, ServerClient packetSubmitter)
    {
        ...
        if (getOwner() != null)
        {
            ...
            {
                getOwner().buffManager.addBuff(new ActiveBuff(APPLEWALKBUFF, getOwner(), 5.0F, null), false);
            }
        }
    }
