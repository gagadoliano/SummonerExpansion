...
import static summonerexpansion.codes.registries.RegistryDebuffs.WeaponDebuffs.BOOKFROZENSLOW;
...
public class IceMinionJavelinProj extends Projectile
{
    ...
    public void doHitLogic(Mob mob, LevelObjectHit object, float x, float y)
    {
        ...
        if (this.isServer() && mob != null)
        {
            ...
            ActiveBuff ab = new ActiveBuff(BOOKFROZENSLOW, mob, 30.0F, this.getOwner());
            mob.addBuff(ab, true);
