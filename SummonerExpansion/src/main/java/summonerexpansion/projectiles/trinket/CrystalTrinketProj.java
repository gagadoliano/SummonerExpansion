...
public class CrystalTrinketProj extends Projectile
{
    ...
    public CrystalTrinketProj(Level level, Mob owner, float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Color particleColor)
    {
        this.setLevel(level);
        this.setOwner(owner);
        this.x = x;
    ...
    {
        return new Trail(this, getLevel(), particleColor, 12.0F, 200, getHeight());
    }
