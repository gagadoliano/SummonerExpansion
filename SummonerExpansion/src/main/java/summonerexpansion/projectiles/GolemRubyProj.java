...
public class GolemRubyProj extends Projectile
{
    ...
    public void doHitLogic(Mob mob, LevelObjectHit object, float x, float y)
    {
        ...
        if (this.isClient() && this.bounced == this.getTotalBouncing())
        {
            ...
            {
                public void addDrawables(Mob target, float x, float y, float angle, java.util.List<LevelSortedDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
