...
import static summonerexpansion.codes.registries.RegistryDebuffs.WeaponDebuffs.ICEWIZARDFROST;
...
public class IceWizardProj extends Projectile
{
    ...
    public void doHitLogic(Mob mob, LevelObjectHit object, float x, float y)
    {
        ...
        if (isServer())
        {
            if (mob != null)
            {
                ActiveBuff ab = new ActiveBuff(ICEWIZARDFROST, mob, 10.0F, this.getOwner());
                mob.addBuff(ab, true);
            }
        }
    }
