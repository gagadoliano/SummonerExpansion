package summonerexpansion.mobs.bosses;
...
import static summonerexpansion.codes.registries.RegistryMobTextures.bossRiftPortal;
...
public class BossRiftPortalMob extends FlyingBossMob
{
    ...
    protected void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        DrawOptions options = bossRiftPortal.initDraw().sprite(sprite, 0, 126).size(126, 102).light(light).mirror(dir == 0, false).pos(drawX, drawY);
    ...
    public void drawOnMap(TickManager tickManager, Client client, int x, int y, double tileScale, Rectangle drawBounds, boolean isMinimap)
    {
        ...
        int drawX = x - 16;
        int drawY = y - 16;
        bossRiftPortal.initDraw().sprite(0, 1, 126, 102).size(48, 48).draw(drawX, drawY);
    }
