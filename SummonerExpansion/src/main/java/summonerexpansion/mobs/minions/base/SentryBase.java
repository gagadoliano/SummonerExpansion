...
public class SentryBase extends AttackingFollowingMob
{
    ...
    {
        attackCooldown = (int)(sentryAttackCooldown * (1.0F / getAttackOwner().buffManager.getModifier(SENTRY_ATTACK_SPEED)));
        attackAnimTime = (int)(sentryAttackAnimTime * (1.0F / getAttackOwner().buffManager.getModifier(SENTRY_ATTACK_SPEED)));
    }
}