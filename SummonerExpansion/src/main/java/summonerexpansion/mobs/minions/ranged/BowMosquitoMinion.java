...
import static summonerexpansion.codes.registries.RegistryDebuffs.WeaponDebuffs.MOSQUITOWEAK;

public class BowMosquitoMinion extends SummonFlyingBase
{
    ...
    public void handleCollisionHit(Mob target, GameDamage damage, int knockback)
    {
        ...
        {
            ActiveBuff buff = new ActiveBuff(MOSQUITOWEAK, target, 60F, this);
