...
import summonerexpansion.projectiles.IceWizardProj;

import java.awt.*;
import java.util.List;

import static summonerexpansion.codes.registries.RegistryMinionTextures.iceWizardMinion;

public class IceWizardMinion extends SummonWalkBase
{
