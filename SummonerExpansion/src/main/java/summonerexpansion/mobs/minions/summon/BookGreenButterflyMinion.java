...
import summonerexpansion.mobs.minions.base.ButterflyBase;

import java.awt.*;
import java.util.List;

import static summonerexpansion.codes.registries.RegistryMinionTextures.butterflyGreenMinion;

public class BookGreenButterflyMinion extends ButterflyBase
{
    public BookGreenButterflyMinion()
    {
        super();
        setSpeed(40.0F);
        setFriction(2.0F);
    ...
    {
        super.init();
        ai = new BehaviourTreeAI<>(this, new PlayerFlyingFollowerCollisionChaserAI<>(800, summonDamage, 15, 1200, 9000, 100), new FlyingAIMover());
    }
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        final DrawOptions options = butterflyGreenMinion.initDraw().sprite(sprite.x, sprite.y, 32).light(light).pos(drawX, drawY);
