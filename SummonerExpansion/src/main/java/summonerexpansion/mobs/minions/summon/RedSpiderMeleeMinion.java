...
import static summonerexpansion.codes.registries.RegistryArmors.registerArmorSets.REDSPIDERDOT;
import static summonerexpansion.codes.registries.RegistryDebuffs.WeaponDebuffs.REDSPIDERPOISON;

public class RedSpiderMeleeMinion extends SummonWalkBase
{
    public RedSpiderMeleeMinion()
    {
        super();
        setSpeed(50.0F);
        setFriction(2.0F);
    ...
    public void handleCollisionHit(Mob target, GameDamage damage, int knockback)
    {
        ...
        {
            ActiveBuff buff2 = new ActiveBuff(REDSPIDERPOISON, target, 5F, this);
            target.addBuff(buff2, true);

            if (owner.buffManager.hasBuff("redspidersetbonus"))
            {
                ActiveBuff buff1 = new ActiveBuff(REDSPIDERDOT, target, 5F, this);
