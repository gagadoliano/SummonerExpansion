...
import static summonerexpansion.codes.registries.RegistryMinionTextures.butterflyRedMinion;

public class BookRedButterflyMinion extends ButterflyBase
{
    public BookRedButterflyMinion()
    {
        super();
        setSpeed(50.0F);
        setFriction(2.0F);
    ...
    {
        super.init();
        ai = new BehaviourTreeAI<>(this, new PlayerFlyingFollowerCollisionChaserAI<>(600, summonDamage, 25, 1200, 9000, 100), new FlyingAIMover());
    }
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        final DrawOptions options = butterflyRedMinion.initDraw().sprite(sprite.x, sprite.y, 32).light(light).pos(drawX, drawY);
