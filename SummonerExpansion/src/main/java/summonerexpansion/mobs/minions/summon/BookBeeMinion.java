...
import static summonerexpansion.codes.registries.RegistryDebuffs.WeaponDebuffs.HONEYBEESLOW;
...
public class BookBeeMinion extends FlyingAttackingFollowingMob
{
    ...
    public void handleCollisionHit(Mob target, GameDamage damage, int knockback)
    {
        ...
        {
            ActiveBuff buff = new ActiveBuff(HONEYBEESLOW, target, 60F, this);
