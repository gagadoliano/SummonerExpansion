...
public class LeafShotSentry extends SentryBase
{
    ...
    {
        super.init();
        ai = new BehaviourTreeAI<>(this, new PlayerFollowerChaserAI<LeafShotSentry>(600, 600, false, false, 90000, 64)
        {
            public boolean attackTarget(LeafShotSentry mob, Mob target)
            {
