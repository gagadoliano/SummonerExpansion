...
import static summonerexpansion.codes.registries.RegistryMinionTextures.fallenDragonHeadMinion;

public class FallenDragonHeadMinion extends AttackingFollowingWormMobHead<FallenDragonBodyMinion, FallenDragonHeadMinion>
{
    ...
    public GameMessage getLocalization() {
        return new LocalMessage("mob", "fallendragonminion");
    }

    protected float getDistToBodyPart(FallenDragonBodyMinion bodyPart, int index, float lastDistance) {
    ...
    protected FallenDragonBodyMinion createNewBodyPart(int index)
    {
        FallenDragonBodyMinion bodyPart = new FallenDragonBodyMinion();
    ...
    {
        this.getLevel().entityManager.addParticle(new FleshParticle(this.getLevel(), fallenDragonHeadMinion, 2, GameRandom.globalRandom.nextInt(6), 32, this.x, this.y, 20.0F, knockbackX, knockbackY), Particle.GType.IMPORTANT_COSMETIC);
    }
    ...
    protected void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        if (this.isVisible())
        {
            ...
            final MobDrawable headDrawable = WormMobHead.getAngledDrawable(new GameSprite(fallenDragonHeadMinion, 0, 0, 64), null, light, (int)this.height, headAngle, drawX, drawY, 96);
            ...
            if (shoulderLine.object != null)
            {
                ...
                shoulderDrawable = WormMobHead.getAngledDrawable(new GameSprite(fallenDragonHeadMinion, 0, 1, 64), null, shoulderLight, (int)shoulderHeight, shoulderAngle, shoulderDrawX, shoulderDrawY, 96);
            }
            else
            {
