...
import static summonerexpansion.codes.registries.RegistryMinionTextures.horrorBullMinion;
...
public class HorrorBullMinion extends AttackingFollowingMob
{
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        final DrawOptions options = horrorBullMinion.initDraw().sprite(sprite.x, sprite.y, 64).alpha(0.7F).light(light).addMaskShader(swimMask).pos(drawX, drawY);
