...
import static summonerexpansion.codes.registries.RegistryMinionTextures.horrorWolfMinion;
...
public class HorrorWolfMinion extends AttackingFollowingMob
{
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        final DrawOptions body = horrorWolfMinion.initDraw().sprite(sprite.x, sprite.y, 64).alpha(0.7F).addMaskShader(swimMask).light(light).pos(drawX, drawY);
