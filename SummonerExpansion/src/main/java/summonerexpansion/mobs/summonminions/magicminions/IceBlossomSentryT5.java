...
public class IceBlossomSentryT5 extends IceBlossomSentry implements OEVicinityBuff
{
    public int flowerRange = 1200;

    public IceBlossomSentryT5()
    {
        super();
    }
    ...
    {
        return new Buff[]{BuffRegistry.getBuff("iceblossombufft5")};
    }
