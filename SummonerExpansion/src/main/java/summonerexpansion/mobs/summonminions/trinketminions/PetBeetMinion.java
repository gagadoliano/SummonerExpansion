...
public class PetBeetMinion extends AttackingFollowingMob
{
    ...
    {
        super.init();
        ai = new BehaviourTreeAI<>(this, new PlayerFollowerChaserAI<PetBeetMinion>(400, 300, false, false, 800, 64)
        {
            public boolean attackTarget(PetBeetMinion mob, Mob target)
            {
                if (mob.canAttack())
                {
