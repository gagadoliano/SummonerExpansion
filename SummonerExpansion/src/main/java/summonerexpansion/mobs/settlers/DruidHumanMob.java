...
public class DruidHumanMob extends HumanShop
{
    ...
    public List<InventoryItem> getRecruitItems(ServerClient client)
    {
        ...
        } else
        {
            ...
            {
                LootTable secondItems = new LootTable(new CountOfTicketLootItems(random.getIntBetween(1, 2), 30, new LootItem("swampsludge", 50), 100, new LootItem("thorns", 50), 50, new LootItem("cattail", 50)));
                ArrayList<InventoryItem> out = GameLootUtils.getItemsValuedAt(random, random.getIntBetween(350, 500), 0.20000000298023224, new LootItem("coin", 1000));
