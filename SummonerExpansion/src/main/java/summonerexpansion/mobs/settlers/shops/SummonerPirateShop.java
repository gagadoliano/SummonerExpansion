...
public class SummonerPirateShop
{
    ...
    {
        NPC.shop.addSellingItem("titaniumbar",  new SellingShopItem(50, 5)).setStaticPriceBasedOnHappiness(500, 1000, 50).addHasCompletedStoryObjectiveRequirement("defeatpestwarden");
        NPC.shop.addBuyingItem("titaniumbar",  new BuyingShopItem()).setPriceBasedOnHappiness(30, 10, 2);
    }
}