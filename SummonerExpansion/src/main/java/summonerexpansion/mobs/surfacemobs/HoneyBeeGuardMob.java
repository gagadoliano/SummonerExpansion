...
import static summonerexpansion.codes.registries.RegistryMobTextures.honeyBeeGuard;
...
public class HoneyBeeGuardMob extends HostileMob implements NetableMob
{
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        final DrawOptions options = honeyBeeGuard.initDraw().sprite(sprite.x, sprite.y, 32).light(light).pos(drawX, drawY);
