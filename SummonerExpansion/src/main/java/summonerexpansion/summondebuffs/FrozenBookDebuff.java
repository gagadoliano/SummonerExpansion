...
public class FrozenBookDebuff extends Buff
{
    public FrozenBookDebuff()
    {
        canCancel = false;
        isImportant = true;
    }
    ...
    public void init(ActiveBuff buff, BuffEventSubscriber eventSubscriber)
    {
        ...
        buff.setModifier(BuffModifiers.FRICTION, -0.25F);
        buff.setModifier(BuffModifiers.DECELERATION, -0.25F);
    }
