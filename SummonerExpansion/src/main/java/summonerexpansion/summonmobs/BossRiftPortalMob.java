...
public class BossRiftPortalMob extends FlyingBossMob
{
    ...
    public class RiftPortalAINode<T extends Mob> extends AINode<T>
    {
        ...
        public AINodeResult tick(T mob, Blackboard<T> blackboard)
        {
            if (nextPhase)
            {
                if (BossRiftPortalMob.this.lifeTime % 600L == 0L)
                {
                ...
                if (nextPhase && BossRiftPortalMob.this.lifeTime % 400L == 0L)
                {
                    Mob portalMob2 = MobRegistry.getMob("horrorspiritbossmob", BossRiftPortalMob.this.getLevel());
                    BossRiftPortalMob.this.getLevel().entityManager.addMob(portalMob2, (float)(BossRiftPortalMob.this.getX() + (int)(GameRandom.globalRandom.nextGaussian() * 3.0)), (float)(BossRiftPortalMob.this.getY() + (int)(GameRandom.globalRandom.nextGaussian() * 3.0)));
                    this.spawnedMobs.add(portalMob2);
                }
            }
            else
            {
                if (BossRiftPortalMob.this.lifeTime % 100L == 0L)
                {
                    Mob portalMob = MobRegistry.getMob("horrorspiritmob", BossRiftPortalMob.this.getLevel());
                    BossRiftPortalMob.this.getLevel().entityManager.addMob(portalMob, (float)(BossRiftPortalMob.this.getX() + (int)(GameRandom.globalRandom.nextGaussian() * 3.0)), (float)(BossRiftPortalMob.this.getY() + (int)(GameRandom.globalRandom.nextGaussian() * 3.0)));
                    this.spawnedMobs.add(portalMob);
