...
public class LeafHeatBallProj extends Projectile
{
    private long spawnTime;

    public LeafHeatBallProj() {}
    ...
    public Trail getTrail() {
        return new Trail(this, this.getLevel(), new Color(145, 0, 13), 12.0F, 500, 18.0F);
    }
