...
public class DruidSwampHouseDuoWorldPreset extends WorldPreset
{
    protected Dimension size = new Dimension(13, 15);
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot", "villages"},
                        (random1, level, timer) ->
                        {
                            ...
                            DruidSwampHouseDuoPreset preset = new DruidSwampHouseDuoPreset(random1);
