...
public class DruidSwampHouseSideWorldPreset extends WorldPreset
{
    protected Dimension size = new Dimension(10, 8);
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot", "villages"},
                        (random1, level, timer) ->
                        {
                            ...
                            DruidSwampHouseSidePreset preset = new DruidSwampHouseSidePreset(random1);
