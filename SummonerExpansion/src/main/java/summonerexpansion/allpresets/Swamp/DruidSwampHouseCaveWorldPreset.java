...
public class DruidSwampHouseCaveWorldPreset extends WorldPreset
{
    protected Dimension size = new Dimension(17, 16);
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot", "villages"},
                        (random1, level, timer) ->
                        {
                            ...
                            DruidSwampHouseCavePreset preset = new DruidSwampHouseCavePreset(random1);
