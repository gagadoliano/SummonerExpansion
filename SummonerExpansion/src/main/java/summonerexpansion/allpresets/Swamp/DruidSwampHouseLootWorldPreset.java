...
public class DruidSwampHouseLootWorldPreset extends WorldPreset
{
    protected Dimension size = new Dimension(11, 12);
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot", "villages"},
                        (random1, level, timer) ->
                        {
                            ...
                            DruidSwampHouseLootPreset preset = new DruidSwampHouseLootPreset(random1);
