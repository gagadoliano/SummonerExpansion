...
import summonerexpansion.items.equips.summonweapons.*;
...
public class SummonerWeapons
{
    public static void registerSummonWeapons()
    {
        ...
        ItemRegistry.registerItem("magiccoppertools", new MagicCopperTools(), 50, true);
        ItemRegistry.registerItem("magicirontools", new MagicIronTools(), 50, true);
        ItemRegistry.registerItem("magicgoldtools", new MagicGoldTools(), 50, true);
        ItemRegistry.registerItem("magicwoodtools", new MagicWoodTools(), 50, true);
        ...
        ItemRegistry.registerItem("yinyangninjastar", new YinYangNinjastar(0, null), 50, true);
        // Melee
