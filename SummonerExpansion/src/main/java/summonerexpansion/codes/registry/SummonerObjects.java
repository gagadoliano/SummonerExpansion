...
public class SummonerObjects
{
    public static void registerSummonObjects()
    {
        ...
        // Plants
        ObjectRegistry.registerObject("overgrowthorns", (new FruitBushObject("overgrowthorns", "overgrowthornssapling", 900.0F, 1800.0F, "thorns", 5.0F, 2, new Color(191, 90, 62))).setDebrisColor(new Color(114, 28, 3)), 0.0F, false, false, true);
        ...
        // Furniture
        ObjectRegistry.registerObject("arcanicdisplay", new DisplayStandObject("arcanicdisplay", new Color(192, 192, 196), 20, "objects", "furniture"), 10F, true);
