...
public class SummonerEquips
{
    ...
    public static void registerSummonTrinkets()
    {
        ...
        BuffRegistry.registerBuff("frozenassassinscowlbuff", new SimpleTrinketBuff("frozenassassinscowltip", new ModifierValue<>(BuffModifiers.SUMMON_CRIT_CHANCE, 0.10F), new ModifierValue<>(BuffModifiers.SUMMON_CRIT_DAMAGE, 0.25F), new ModifierValue<>(BuffModifiers.PROJECTILE_VELOCITY, 0.50F)));
        ...
        BuffRegistry.registerBuff("spelltabletbuff", new SimpleTrinketBuff("spelltablettip", new ModifierValue<>(BuffModifiers.MAX_MANA, 0.50F), new ModifierValue<>(BuffModifiers.MAX_SUMMONS, 2), new ModifierValue<>(BuffModifiers.SUMMON_ATTACK_SPEED, 0.30F), new ModifierValue<>(BuffModifiers.MAGIC_ATTACK_SPEED, 0.30F)));
        ...
        BuffRegistry.registerBuff("inducingsatchelbuff", new SimpleTrinketBuff("inducingsatcheltip", new ModifierValue<>(BuffModifiers.SUMMON_ATTACK_SPEED, 0.10F), new ModifierValue<>(BuffModifiers.SUMMONS_SPEED, 0.30F), new ModifierValue<>(BuffModifiers.SPEED, 0.10F), new ModifierValue<>(BuffModifiers.EMITS_LIGHT, true)));
        ...
        BuffRegistry.registerBuff("hystericalmirrorbuff", new SimpleTrinketBuff("hystericalmirrortip", new ModifierValue<>(BuffModifiers.MAX_SUMMONS, 3), new ModifierValue<>(BuffModifiers.SUMMONS_SPEED, 0.30F)));
        ...
        BuffRegistry.registerBuff("bonepilebuff", new SimpleTrinketBuff("bonepiletip", new ModifierValue<>(BuffModifiers.ARMOR_PEN_FLAT, 20), new ModifierValue<>(BuffModifiers.SUMMON_CRIT_DAMAGE, 0.05F)));
