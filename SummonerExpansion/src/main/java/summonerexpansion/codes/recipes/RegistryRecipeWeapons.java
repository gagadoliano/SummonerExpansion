...
public class RegistryRecipeWeapons
{
    public static void registerRecipes()
    {
        RegistryRecipeWeapons.registerTier1();
        RegistryRecipeWeapons.registerTier2();
        RegistryRecipeWeapons.registerTier3();
        RegistryRecipeWeapons.registerTier4();
        RegistryRecipeWeapons.registerBooks();
    }
