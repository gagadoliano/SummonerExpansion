...
public class RegistryChallenges
{
    ...
    {
        //Forest
        DUCK_KILL_ID = registerChallenge("duckkilled", new MobsKilledJournalChallenge(10, "duck"));
        ...
        WATERGRASS_COLLECT_ID = registerChallenge("watergrasscollected", new PickupItemsJournalChallenge(25, true, "watergrass"));
        ...
        //Forest cave
        BEET_KILL_ID = registerChallenge("beetkilled", new CaveKillJournalChallenge(10, "cropplerbeet"));
        ...
        //Forest deep cave
        ONION_KILL_ID = registerChallenge("onionkilled", new CaveKillJournalChallenge(10, "croppleronion"));
        ...
        //Snow cave
        POTATO_KILL_ID = registerChallenge("potatokilled", new CaveKillJournalChallenge(10, "cropplerpotato"));
        ...
        //Snow deep cave
        PUMPKIN_KILL_ID = registerChallenge("pumpkinkilled", new CaveKillJournalChallenge(10, "cropplerpumpkin"));
        ...
        //Plains
        FIREFLY_COLLECT_ID = registerChallenge("fireflycollected", new PickupItemsJournalChallenge(5, true, "fireflyyellow", "fireflygreen", "fireflyblue"));
        ...
        WHITEFLOWER_PLACE_ID = registerChallenge("whiteflowerplaced", new ObjectsPlacedJournalChallenge(10, "whiteflowerpatch"));
        ...
        //Swamp cave
        SPORE_KILL_ID = registerChallenge("sporekilled", new MobsKilledJournalChallenge(8, "swampsporedummy"));
        MUSHROOM_COLLECT_ID = registerChallenge("mushroomcollected", new PickupItemsJournalChallenge(50, true, "mushroom"));
        MUD_COLLECT_ID = registerChallenge("mudcollected", new PickupItemsJournalChallenge(40, true, "mudtile"));
        STINKFLASK_COLLECT_ID = registerChallenge("stinkflaskcollected", new ItemObtainedJournalChallenge("stinkflask"));
        ...
        SHELL_DESTROY_ID = registerChallenge("shelldestroyed", new ObjectsDestroyedJournalChallenge(20, true, "seashell", "seasnail", "seastar"));
        ...
        //Desert cave
        CARROT_KILL_ID = registerChallenge("carrotkilled", new CaveKillJournalChallenge(10, "cropplercarrot"));
