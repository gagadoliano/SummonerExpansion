...
public class WitchHideoutWorldPreset extends WorldPreset
{
    protected Dimension size = new Dimension(12, 10);
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot"},
                        (random1, level, timer) ->
                        {
                            ...
                            WitchHideoutPreset preset = new WitchHideoutPreset(random1);
