...
public class DruidSwampHouseCookWorldPreset extends WorldPreset
{
    protected Dimension size = new Dimension(24, 18);
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot", "villages"},
                        (random1, level, timer) ->
                        {
                            ...
                            DruidSwampHouseCookPreset preset = new DruidSwampHouseCookPreset(random1);
