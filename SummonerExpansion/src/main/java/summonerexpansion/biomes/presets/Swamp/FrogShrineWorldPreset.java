...
public class FrogShrineWorldPreset extends WorldPreset
{
    protected Dimension size = new Dimension(15, 13);
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot", "villages"},
                    (random1, level, timer) ->
                    {
                        ...
                        FrogShrinePreset preset = new FrogShrinePreset(random1);
