...
public class SandLibraryWorldPreset extends WorldPreset
{
    protected Dimension size = new Dimension(28, 48);
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot"},
                        (random1, level, timer) ->
                        {
                            ...
                            SandLibraryPreset preset = new SandLibraryPreset(random1);
