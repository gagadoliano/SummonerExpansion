...
public class SandTempleWorldPreset extends WorldPreset
{
    protected Dimension size = new Dimension(26, 40);
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot"},
                        (random1, level, timer) ->
                        {
                            ...
                            SandTemplePreset preset = new SandTemplePreset(random1);
