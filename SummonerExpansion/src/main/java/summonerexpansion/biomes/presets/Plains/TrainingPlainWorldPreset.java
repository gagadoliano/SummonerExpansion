package summonerexpansion.biomes.presets.Plains;
...
public class TrainingPlainWorldPreset extends WorldPreset
{
            ...
            if (tile != null)
            {
                presetsRegion.addPreset(this, tile.x, tile.y, size, new String[]{"loot"},
                        (random1, level, timer) ->
                        {
                            ...
                            TrainingPlainPreset preset = new TrainingPlainPreset(random1);
