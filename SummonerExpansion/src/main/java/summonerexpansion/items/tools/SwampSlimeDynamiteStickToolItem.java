...
import summonerexpansion.projectiles.SwampSlimeDynamiteStickProjectile;

import java.awt.*;

public class SwampSlimeDynamiteStickToolItem extends SettlerIgnoredThrowToolItem
{
    public SwampSlimeDynamiteStickToolItem()
    {
        this.stackSize = 100;
    ...
    public ListGameTooltips getPreEnchantmentTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard)
    {
        ...
        tooltips.add(Localization.translate("itemtooltip", "swampslimedynamitesticktip"));
        return tooltips;
    }
    ...
    public InventoryItem onAttack(Level level, int x, int y, ItemAttackerMob attackerMob, int attackHeight, InventoryItem item, ItemAttackSlot slot, int animAttack, int seed, GNDItemMap mapContent)
    {
        ...
        SwampSlimeDynamiteStickProjectile projectile = new SwampSlimeDynamiteStickProjectile(attackerMob.x, attackerMob.y, (float)targetPos.x, (float)targetPos.y, this.getThrowingVelocity(item, attackerMob), newRange, this.getAttackDamage(item), attackerMob);
