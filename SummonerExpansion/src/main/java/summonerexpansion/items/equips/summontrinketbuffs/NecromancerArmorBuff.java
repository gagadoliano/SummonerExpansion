...
public class NecromancerArmorBuff extends TrinketBuff
{
    ...
    public void init(ActiveBuff buff, BuffEventSubscriber eventSubscriber)
    {
        ...
        buff.setModifier(BuffModifiers.SUMMON_CRIT_CHANCE, 0.15F);
        buff.setModifier(BuffModifiers.SUMMON_CRIT_DAMAGE, 0.45F);
        buff.setModifier(BuffModifiers.ARMOR_PEN_FLAT, 25);
