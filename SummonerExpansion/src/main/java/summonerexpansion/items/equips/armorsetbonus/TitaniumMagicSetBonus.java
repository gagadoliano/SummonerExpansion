...
public class TitaniumMagicSetBonus extends TitaniumSetBonus
{
    ...
    public void serverTick(ActiveBuff buff)
    {
        ...
        if (buff.owner.isItemAttacker && halfMana)
        {
            ...
            if (count <= 0.0F)
            {
                ...
                FlyingAttackingFollowingMob mob = (FlyingAttackingFollowingMob) MobRegistry.getMob("settitaniummagicminion", level);
                attackerMob.serverFollowersManager.addFollower("summonedtitaniumstaff", mob, FollowPosition.WALK_CLOSE, "summonedtitaniumminionbuff", 1.0F, 1, null, false);
    ...
    public ListGameTooltips getTooltip(ActiveBuff ab, GameBlackboard blackboard)
    {
        ...
        tooltips.add(Localization.translate("itemtooltip", "titaniummagictip"));
        return tooltips;
    }
