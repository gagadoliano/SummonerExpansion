...
public class LittleMecha extends TrinketItem
{
    public LittleMecha(int enchantCost, Item.Rarity rarityTier)
    {
        super(rarityTier, enchantCost, TrinketsLootTable.trinkets);
        disabledBy.add("spiritgreaves");
        disabledBy.add("secondwindcharm");
        disabledBy.add("ancientrelics");
        disabledBy.add("challengerarmorpiece");
        disabledBy.add("transplantedheart");
        disabledBy.add("summonfoci");
    }

    public TrinketBuff[] getBuffs(InventoryItem item)
    {
        return new TrinketBuff[]{(TrinketBuff) BuffRegistry.getBuff("littlemechabuff")};
    }

    public ListGameTooltips getPreEnchantmentTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard)
    {
        ListGameTooltips tooltips = super.getPreEnchantmentTooltips(item, perspective, blackboard);
        tooltips.add(Localization.translate("itemtooltip", "littlemechatip"));
        return tooltips;
    }
