...
public class MagicWoodTools extends SummonToolItem
{
    public IntUpgradeValue maxSummons = new IntUpgradeValue(3, 0.0F);

    public MagicWoodTools(int enchantCost, Item.Rarity rarityTier)
    {
        super("woodaxeminion", FollowPosition.FLYING_CIRCLE, 1F, enchantCost, SummonWeaponsLootTable.summonWeapons);
    ...
    {
        FlyingAttackingFollowingMob mob1 = (FlyingAttackingFollowingMob) MobRegistry.getMob("woodaxeminion", level);
        FlyingAttackingFollowingMob mob2 = (FlyingAttackingFollowingMob) MobRegistry.getMob("woodpickminion", level);
    ...
    public ListGameTooltips getPreEnchantmentTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard)
    {
        ...
        tooltips.add(Localization.translate("itemtooltip", "woodtoolstip"));
