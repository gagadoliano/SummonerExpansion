...
{
    public EnchantedBrainOnAStick(int enchantCost, Item.Rarity rarityTier)
    {
        super("enchantedbabyzombieminion", FollowPosition.PYRAMID, 0.5F, enchantCost, SummonWeaponsLootTable.summonWeapons);
        rarity = rarityTier;
