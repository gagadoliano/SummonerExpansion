...
public class BookFrozen extends SummonToolItem
{
    ...
    public BookFrozen(int enchantCost, Item.Rarity rarityTier)
    {
        super("frozendwarfminion", FollowPosition.WALK_CLOSE, 1F, enchantCost, SummonWeaponsLootTable.summonWeapons);
