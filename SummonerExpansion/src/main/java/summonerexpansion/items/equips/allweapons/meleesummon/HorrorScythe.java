...
import summonerexpansion.codes.events.HorrorScytheHandler;

import java.awt.*;

public class HorrorScythe extends GreatswordToolItem
{
    public HorrorScythe(int enchantCost, Item.Rarity rarityTier)
    {
        super(enchantCost, SummonWeaponsLootTable.summonWeapons, HorrorScythe.getChargeLevels(600, 800, 1200));
        keyWords.add("summon");
