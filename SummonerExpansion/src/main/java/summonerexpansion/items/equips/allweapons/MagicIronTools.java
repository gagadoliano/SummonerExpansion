...
public class MagicIronTools extends SummonToolItem
{
    public IntUpgradeValue maxSummons = new IntUpgradeValue(3, 0.0F);

    public MagicIronTools(int enchantCost, Item.Rarity rarityTier)
    {
        super("ironaxeminion", FollowPosition.FLYING_CIRCLE, 1F, enchantCost, SummonWeaponsLootTable.summonWeapons);
        summonType = "summonedmagictoolminion";
        rarity = rarityTier;
        drawMaxSummons = false;
        canBeUsedForRaids = true;
        knockback.setBaseValue(40);
        attackDamage.setBaseValue(10.0F).setUpgradedValue(1, 45.0F);
    ...
    {
        FlyingAttackingFollowingMob mob1 = (FlyingAttackingFollowingMob) MobRegistry.getMob("ironaxeminion", level);
        FlyingAttackingFollowingMob mob2 = (FlyingAttackingFollowingMob) MobRegistry.getMob("ironpickminion", level);
    ...
    public ListGameTooltips getPreEnchantmentTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard)
    {
        ...
        tooltips.add(Localization.translate("itemtooltip", "irontoolstip"));
