...
{
    public BearPolarHead(int enchantCost, Item.Rarity rarityTier)
    {
        super("bearpolarminion", FollowPosition.WALK_CLOSE, 2F, enchantCost, SummonWeaponsLootTable.summonWeapons);
        rarity = rarityTier;
