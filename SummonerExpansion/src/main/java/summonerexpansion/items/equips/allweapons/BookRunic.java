...
public class BookRunic extends SummonToolItem
{
    ...
    public BookRunic(int enchantCost, Item.Rarity rarityTier)
    {
        super("runicshieldminion", FollowPosition.FLYING_CIRCLE, 1F, enchantCost, SummonWeaponsLootTable.summonWeapons);
