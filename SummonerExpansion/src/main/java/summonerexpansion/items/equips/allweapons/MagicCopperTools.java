...
public class MagicCopperTools extends SummonToolItem
{
    public IntUpgradeValue maxSummons = new IntUpgradeValue(3, 0.0F);

    public MagicCopperTools(int enchantCost, Item.Rarity rarityTier)
    {
        super("copperaxeminion", FollowPosition.FLYING_CIRCLE, 1F, enchantCost, SummonWeaponsLootTable.summonWeapons);
        summonType = "summonedmagictoolminion";
        rarity = rarityTier;
        drawMaxSummons = false;
        canBeUsedForRaids = true;
        knockback.setBaseValue(37);
        attackDamage.setBaseValue(7.0F).setUpgradedValue(1, 40.0F);
    ...
    {
        FlyingAttackingFollowingMob mob1 = (FlyingAttackingFollowingMob) MobRegistry.getMob("copperpickminion", level);
        FlyingAttackingFollowingMob mob2 = (FlyingAttackingFollowingMob) MobRegistry.getMob("copperaxeminion", level);
    ...
    public ListGameTooltips getPreEnchantmentTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard)
    {
        ...
        tooltips.add(Localization.translate("itemtooltip", "coppertoolstip"));
