...
{
    public BookBee(int enchantCost, Item.Rarity rarityTier)
    {
        super("beebookminion", FollowPosition.FLYING_CIRCLE, 1F, enchantCost, SummonWeaponsLootTable.summonWeapons);
        summonType = "summonedbeebookminion";
        rarity = rarityTier;
