...
{
    public GemRubyShards(int enchantCost, Item.Rarity rarityTier)
    {
        super("golemrubyminion", FollowPosition.WALK_CLOSE, 1F, enchantCost, SummonWeaponsLootTable.summonWeapons);
        rarity = rarityTier;
