...
public class GoblinSword extends SwordToolItem implements ItemInteractAction
{
    ...
    public InventoryItem onLevelInteract(Level level, int x, int y, final ItemAttackerMob attackerMob, int attackHeight, final InventoryItem item, ItemAttackSlot slot, final int seed, GNDItemMap mapContent)
    {
        ...
        if (attackerMob.isServer() && attackerMob.buffManager.getStacks(BuffRegistry.getBuff("goblinswordstack")) >= 50)
        {
            ...
            attackerMob.serverFollowersManager.addFollower("summonedgoblinheadminion", mob1, FollowPosition.WALK_CLOSE, "summonedmob", 1.0F, 1, null, false);
            ...
            attackerMob.serverFollowersManager.addFollower("summonedgoblinchestminion", mob2, FollowPosition.WALK_CLOSE, "summonedmob", 1.0F, 1, null, false);
            ...
            attackerMob.serverFollowersManager.addFollower("summonedgoblinlegminion", mob3, FollowPosition.WALK_CLOSE, "summonedmob", 1.0F, 1, null, false);
