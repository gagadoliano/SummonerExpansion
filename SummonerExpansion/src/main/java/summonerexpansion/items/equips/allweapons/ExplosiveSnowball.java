...
public class ExplosiveSnowball extends SummonToolItem
{
    ...
    public ExplosiveSnowball(int enchantCost, Item.Rarity rarityTier)
    {
        super("explosivesnowmanminion", FollowPosition.PYRAMID, 1F, enchantCost, SummonWeaponsLootTable.summonWeapons);
        summonType = "summonedexplosivesnowmanminion";
        rarity = rarityTier;
