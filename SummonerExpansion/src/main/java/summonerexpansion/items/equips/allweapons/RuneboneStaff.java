...
public class RuneboneStaff extends SummonToolItem
{
    ...
    public RuneboneStaff(int enchantCost, Item.Rarity rarityTier)
    {
        super("runemeleeminion", FollowPosition.WALK_CLOSE, 1F, enchantCost, SummonWeaponsLootTable.summonWeapons);
        rarity = rarityTier;
