...
import summonerexpansion.summonprojs.SharpshooterProj;
...
public class SharpshooterSummonSetBonus extends SetBonusBuff
{
    ...
    public void serverTick(ActiveBuff buff)
    {
        ...
        if (buff.owner.isItemAttacker)
        {
            ...
            float count = attackerMob.serverFollowersManager.getFollowerCount("sharpshooterminion");
            if (count <= 0.0F)
            {
                ...
                attackerMob.serverFollowersManager.addFollower("sharpshooterminion", mob, FollowPosition.WALK_CLOSE, "summonedsharpshooterbuff", 1.0F, 1, null, false);
