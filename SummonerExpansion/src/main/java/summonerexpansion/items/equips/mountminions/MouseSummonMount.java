...
public class MouseSummonMount extends BaseTransformMount implements MountAbility
{
    ...
    {
        SoundManager.playSound(GameResources.mouseAmbient, SoundEffect.effect(this).pitch(GameRandom.globalRandom.getFloatBetween(1.0F, 1.25F)).volume(0.4F), new SimpleSoundCooldown(700));
    }
