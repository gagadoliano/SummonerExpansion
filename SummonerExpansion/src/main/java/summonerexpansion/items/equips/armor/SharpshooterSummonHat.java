...
public class SharpshooterSummonHat extends SetHelmetArmorItem
{
    ...
    {
        super(22, DamageTypeRegistry.SUMMON, enchantCost, HeadArmorLootTable.headArmor, ArmorSetsLootTable.armorSets, rarityTier, "sharpshootersummonhat", "sharpshootercoat", "sharpshooterboots", "sharpshootersummonsetbonus");
