...
public class ShadowHorrorMantle extends ChestArmorItem
{
    ...
    public ShadowHorrorMantle(int enchantCost, Item.Rarity rarityTier)
    {
        super(25, enchantCost, rarityTier, "shadowhorrormantle", "shadowhorrorarms", BodyArmorLootTable.bodyArmor);
