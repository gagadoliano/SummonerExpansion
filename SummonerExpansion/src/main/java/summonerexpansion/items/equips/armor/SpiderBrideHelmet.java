...
public class SpiderBrideHelmet extends SetHelmetArmorItem
{
    ...
    {
        super(19, DamageTypeRegistry.SUMMON, enchantCost, HeadArmorLootTable.headArmor, ArmorSetsLootTable.armorSets, rarityTier, "spiderbridehelmet", "spiderbridechest", "spiderbrideboots", "spiderbridesetbonus");
