...
public class AgedSummonerHelmet extends SetHelmetArmorItem
{
    ...
    {
        super(24, DamageTypeRegistry.SUMMON, enchantCost, HeadArmorLootTable.headArmor, ArmorSetsLootTable.armorSets, rarityTier, "agedsummonerhelmet", "agedchampionchestplate", "agedchampiongreaves", "agedsummonersetbonus");
