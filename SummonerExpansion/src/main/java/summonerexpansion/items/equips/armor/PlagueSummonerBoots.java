...
public class PlagueSummonerBoots extends BootsArmorItem
{
    ...
    public PlagueSummonerBoots(int enchantCost, Item.Rarity rarityTier)
    {
        super(15, enchantCost, rarityTier, "summonplagueboots", FeetArmorLootTable.feetArmor);
    }
