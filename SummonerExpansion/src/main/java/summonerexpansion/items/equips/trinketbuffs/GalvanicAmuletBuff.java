...
public class GalvanicAmuletBuff extends TrinketBuff
{
    public int attackCooldown;
    static GameDamage damage = new GameDamage(DamageTypeRegistry.SUMMON, 30);

    public GalvanicAmuletBuff() {}
    ...
    public ListGameTooltips getTrinketTooltip(TrinketItem trinketItem, InventoryItem item, PlayerMob perspective)
    {
        ...
        tooltips.add(Localization.translate("itemtooltip", "galvanicamulettip"));
        ...
        tooltips.add(Localization.translate("itemtooltip", "galvanicamulettip2", "damage", (int)damageStat));
        return tooltips;
    }
}