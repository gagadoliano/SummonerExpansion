...
import static summonerexpansion.codes.registries.RegistryMinionTextures.cavelingMinecartMount;
...
public class CavelingMinecartMount extends MinecartMountMob
{
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        final DrawOptions behind = cavelingMinecartMount.initDraw().sprite(sprite.x, sprite.y, 64).addMaskShader(swimMask).light(light).pos(drawX, drawY);
