...
public class BaseDruidClaw extends SwordToolItem implements ItemInteractAction
{
    ...
    public BaseDruidClaw(int enchantCost, OneOfLootItems lootTableCategory)
    {
    ...
    public void hitMob(InventoryItem item, ToolItemMobAbilityEvent event, Level level, Mob target, Mob attacker)
    {
        ...
        {
            attacker.buffManager.removeStack(CLAW_DASH_STACKS, true, level.isServer());
        }
    }
    ...
    {
        return !attackerMob.isRiding() && !attackerMob.buffManager.hasBuff(CLAW_DASH_COOLDOWN);
    }
