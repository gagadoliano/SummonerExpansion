...
import static summonerexpansion.codes.registries.RegistryBuffs.WeaponBuffs.CLAWVULTURESPEED;

public class DruidVultureClaw extends BaseDruidClaw implements ItemInteractAction
{
    ...
    public void hitMob(InventoryItem item, ToolItemMobAbilityEvent event, Level level, Mob target, Mob attacker)
    {
        ...
        attacker.buffManager.addBuff(new ActiveBuff(CLAWVULTURESPEED, attacker, debuffDuration.getValue(getUpgradeTier(item)), null), true);
    }
