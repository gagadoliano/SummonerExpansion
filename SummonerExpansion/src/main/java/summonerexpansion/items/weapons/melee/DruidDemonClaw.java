...
import summonerexpansion.mobs.minions.melee.ClawDemonPortalSentry;

import java.awt.*;

import static summonerexpansion.codes.registries.RegistryBuffs.WeaponBuffs.CLAWDEMON;

public class DruidDemonClaw extends BaseDruidClaw implements ItemInteractAction
{
