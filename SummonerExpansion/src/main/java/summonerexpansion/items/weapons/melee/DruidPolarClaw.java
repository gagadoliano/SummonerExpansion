...
import static summonerexpansion.codes.registries.RegistryDebuffs.WeaponDebuffs.CLAWPOLARSLOW;

public class DruidPolarClaw extends BaseDruidClaw implements ItemInteractAction
{
    ...
    public void hitMob(InventoryItem item, ToolItemMobAbilityEvent event, Level level, Mob target, Mob attacker)
    {
        ...
        target.buffManager.addBuff(new ActiveBuff(CLAWPOLARSLOW, target, debuffDuration.getValue(getUpgradeTier(item)), attacker), true);
    }
