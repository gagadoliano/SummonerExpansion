...
import static summonerexpansion.codes.registries.RegistryDebuffs.WeaponDebuffs.CLAWNECROPOISON;

public class DruidNecroticClaw extends BaseDruidClaw implements ItemInteractAction
{
    ...
    public void hitMob(InventoryItem item, ToolItemMobAbilityEvent event, Level level, Mob target, Mob attacker)
    {
        ...
        target.buffManager.addBuff(new ActiveBuff(CLAWNECROPOISON, target, debuffDuration.getValue(getUpgradeTier(item)), attacker), true);
    }
