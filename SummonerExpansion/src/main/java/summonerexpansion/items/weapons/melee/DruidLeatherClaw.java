...
import static summonerexpansion.codes.registries.RegistryDebuffs.WeaponDebuffs.CLAWLEATHERWEAK;

public class DruidLeatherClaw extends BaseDruidClaw implements ItemInteractAction
{
    ...
    public void hitMob(InventoryItem item, ToolItemMobAbilityEvent event, Level level, Mob target, Mob attacker)
    {
        ...
        target.buffManager.addBuff(new ActiveBuff(CLAWLEATHERWEAK, target, debuffDuration.getValue(getUpgradeTier(item)), attacker), true);
    }
