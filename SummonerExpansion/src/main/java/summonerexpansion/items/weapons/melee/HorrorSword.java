...
import summonerexpansion.mobs.minions.melee.HorrorCrawlingZombieMinion;

import java.awt.geom.Point2D;

public class HorrorSword extends BaseSummonSwordWeapon
{
    ...
    public void hitMob(InventoryItem item, ToolItemMobAbilityEvent event, Level level, Mob target, Mob attacker)
    {
        ...
        {
            ActiveBuff ab = new ActiveBuff(BuffRegistry.getBuff("horrorswordstack"), attacker, 31F, attacker);
