...
import static summonerexpansion.codes.registries.RegistryDebuffs.WeaponDebuffs.CLAWPRIMORDIAL;

public class DruidPrimordialClaws extends BaseDruidClaw implements ItemInteractAction
{
    ...
    public void hitMob(InventoryItem item, ToolItemMobAbilityEvent event, Level level, Mob target, Mob attacker)
    {
        ...
        target.buffManager.addBuff(new ActiveBuff(CLAWPRIMORDIAL, target, debuffDuration.getValue(getUpgradeTier(item)), attacker), true);
    }
