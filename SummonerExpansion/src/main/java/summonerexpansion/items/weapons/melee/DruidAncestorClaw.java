...
import static summonerexpansion.codes.registries.RegistryBuffs.WeaponBuffs.CLAWANCESTOR;

public class DruidAncestorClaw extends BaseDruidClaw implements ItemInteractAction
{
    ...
    public void hitMob(InventoryItem item, ToolItemMobAbilityEvent event, Level level, Mob target, Mob attacker)
    {
        ...
        attacker.buffManager.addBuff(new ActiveBuff(CLAWANCESTOR, attacker, debuffDuration.getValue(getUpgradeTier(item)), null), true);
    }
    ...
    public InventoryItem onAttack(Level level, int x, int y, ItemAttackerMob attackerMob, int attackHeight, InventoryItem item, ItemAttackSlot slot, int animAttack, int seed, GNDItemMap mapContent)
    {
        ...
        Buff ancestorBuff = CLAWANCESTOR;
