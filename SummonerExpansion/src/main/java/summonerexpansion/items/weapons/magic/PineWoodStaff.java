...
import summonerexpansion.mobs.minions.magic.PineWoodMinion;

import java.awt.geom.Point2D;

public class PineWoodStaff extends BaseSummonMagicWeapon implements ItemInteractAction
{
    ...
    public InventoryItem onAttack(Level level, int x, int y, ItemAttackerMob attackerMob, int attackHeight, InventoryItem item, ItemAttackSlot slot, int animAttack, int seed, GNDItemMap mapContent)
    {
        ...
        attackerMob.buffManager.addBuff(new ActiveBuff(BuffRegistry.getBuff("pinewoodbuff"), attackerMob, 31F, null), false);
        return item;
    }
