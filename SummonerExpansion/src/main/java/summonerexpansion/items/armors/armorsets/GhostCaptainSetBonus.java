...
import summonerexpansion.items.armors.minions.SetGhostCaptainMinion;
...
public class GhostCaptainSetBonus extends SetBonusBuff implements BuffAbility
{
    ...
    public void runAbility(PlayerMob player, ActiveBuff buff, Packet content)
    {
        ...
        player.buffManager.addBuff(new ActiveBuff(RegistryArmors.registerArmorSets.GHOSTSETCOOLDOWN, player, cooldown, null), false);
    }

    public boolean canRunAbility(PlayerMob player, ActiveBuff buff, Packet content)
    {
        return !buff.owner.buffManager.hasBuff(RegistryArmors.registerArmorSets.GHOSTSETCOOLDOWN);
    }
