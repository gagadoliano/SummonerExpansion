...
import summonerexpansion.items.armors.minions.SetSpiderBrideMinion;
...
public class SpiderBrideSetBonus extends SetBonusBuff implements BuffAbility
{
    ...
    {
        return !buff.owner.buffManager.hasBuff(RegistryArmors.registerArmorSets.SPIDERBRIDECOOLDOWN);
    }
