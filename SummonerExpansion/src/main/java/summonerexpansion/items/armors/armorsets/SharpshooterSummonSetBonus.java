...
import summonerexpansion.projectiles.armorset.SharpshooterProj;
    ...
    public void serverTick(ActiveBuff buff)
    {
        ...
        if (buff.owner.isItemAttacker)
        {
            ...
            if (count <= 0.0F)
            {
                ...
                AttackingFollowingMob mob = (AttackingFollowingMob) MobRegistry.getMob("setsharpshooterminion", level);
