...
import static summonerexpansion.codes.registries.RegistryArmors.registerArmorSets.LAVASHARKBLEED;
import static summonerexpansion.codes.registries.RegistryArmors.registerArmorSets.LAVASHARKFRENZY;
...
public class SharkLavaSetBonus extends SetBonusBuff
{
    ...
    protected void globalTick(ActiveBuff buff)
    {
        ...
        if (tick % 10 == 0)
        {
            ...
            Buff speedBuff = LAVASHARKFRENZY;
    ...
    public void onHasAttacked(ActiveBuff buff, MobWasHitEvent event)
    {
        ...
        {
            ActiveBuff bleedDebuff = new ActiveBuff(LAVASHARKBLEED, event.target, buffDuration.getValue(buff.getUpgradeTier()), buff.owner);
