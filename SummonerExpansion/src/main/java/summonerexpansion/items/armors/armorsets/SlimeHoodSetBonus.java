...
public class SlimeHoodSetBonus extends SetBonusBuff implements BuffAbility
{
    ...
    public void serverTick(ActiveBuff buff)
    {
        ...
        if (buff.owner.isItemAttacker)
        {
            ...
            if (count1 <= 0.0F)
            {
                AttackingFollowingMob mob1 = (AttackingFollowingMob) MobRegistry.getMob("setslimemageminion", level);
            ...
            if (count2 <= 0.0F)
            {
                AttackingFollowingMob mob2 = (AttackingFollowingMob) MobRegistry.getMob("setslimewarriorminion", level);
