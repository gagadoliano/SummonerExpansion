...
import static summonerexpansion.codes.registries.RegistryMinionTextures.setTitaniumRangedMinion;
...
public class SetTitaniumRangedMinion extends FlyingAttackingFollowingMob
{
    ...
    protected void updateBowRotation()
    {
        if (rotationDisabledTimer <= 0)
        {
            ...
            {
                ActiveBuff buff = followingMob.buffManager.getBuff(TITANIUMRANGEDSET);
    ...
    protected void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        GameTexture texture = setTitaniumRangedMinion;
