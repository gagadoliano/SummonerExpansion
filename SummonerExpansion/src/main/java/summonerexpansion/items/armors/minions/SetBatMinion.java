...
import static summonerexpansion.codes.registries.RegistryMinionTextures.setBatMinion;
...
public class SetBatMinion extends SummonFlyingBase
{
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        final TextureDrawOptionsEnd drawOptions = setBatMinion.initDraw().sprite(sprite.x, sprite.y, 64).light(light).pos(drawX, drawY);
