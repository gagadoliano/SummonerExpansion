...
import static summonerexpansion.codes.registries.RegistryMinionTextures.trinketHorrorBatMinion;

public class TrinketHorrorBatMinion extends FlyingAttackingFollowingMob
{
    public int lifeTime = 0;

    public TrinketHorrorBatMinion()
    {
        super(10);
        setSpeed(50.0F);
        setFriction(2.0F);
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective)
    {
        ...
        final TextureDrawOptionsEnd drawOptions = trinketHorrorBatMinion.initDraw().sprite(sprite.x, sprite.y, 64).light(light).pos(drawX, drawY);
