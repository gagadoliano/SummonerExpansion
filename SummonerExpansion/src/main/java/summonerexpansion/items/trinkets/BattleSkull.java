...
public class BattleSkull extends TrinketItem
{
    public BattleSkull(int enchantCost, Item.Rarity rarityTier)
    {
        super(rarityTier, enchantCost, TrinketsLootTable.trinkets);
        disabledBy.add("necroticsoulskull");
    ...
    {
        return new TrinketBuff[]{(TrinketBuff) BuffRegistry.getBuff("battleskullbuff")};
    }

    public ListGameTooltips getPreEnchantmentTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard)
    {
        ListGameTooltips tooltips = super.getPreEnchantmentTooltips(item, perspective, blackboard);
        tooltips.add(Localization.translate("itemtooltip", "battleskulltip"));
        return tooltips;
    }
