...
public class SporeBagAuraBuff extends AuraTrinketBuff
{
    public SporeBagAuraBuff() {
        super(320);
    }
    ...
    {
        return BuffRegistry.getBuff("sporebagbuff");
    }

    public ListGameTooltips getTrinketTooltip(TrinketItem trinketItem, InventoryItem item, PlayerMob perspective)
    {
        ListGameTooltips tooltips = new ListGameTooltips();
        tooltips.add(Localization.translate("itemtooltip", "sporebagtip"));
        return tooltips;
    }
}