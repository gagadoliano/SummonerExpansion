...
import static summonerexpansion.items.trinkets.trinketsbuffs.ScryingMagiciansCardBuff.spawnMagicMummy;
import static summonerexpansion.items.trinkets.trinketsbuffs.ScryingMagiciansCardBuff.spawnSummonMummy;

public class MagicianBoardBuff extends TrinketBuff
{
    public MagicianBoardBuff() {}

    public void init(ActiveBuff buff, BuffEventSubscriber eventSubscriber)
    {
        buff.setModifier(BuffModifiers.MAX_SUMMONS, 4);
    ...
    public ListGameTooltips getTrinketTooltip(TrinketItem trinketItem, InventoryItem item, PlayerMob perspective)
    {
        ...
        tooltips.add(Localization.translate("itemtooltip", "magicianboardtip"));
        tooltips.add(new SpacerGameTooltip(5));
        tooltips.add(new StringTooltips(Localization.translate("itemtooltip", "mummytrinkettip", "value", 1), new Color(211, 109, 20), 400));
        tooltips.add(new SpacerGameTooltip(5));
