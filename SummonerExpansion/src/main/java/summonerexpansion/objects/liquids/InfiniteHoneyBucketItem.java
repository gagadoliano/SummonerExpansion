package summonerexpansion.objects.liquids;
...
import static summonerexpansion.codes.registries.RegistryTiles.liquidHoneyID;
...
public class InfiniteHoneyBucketItem extends PlaceableItem implements ItemInteractAction
{
    ...
    protected void loadItemTextures() {
        itemTexture = GameTexture.fromFile("items/tiles/" + getStringID());
    }
