...
import static summonerexpansion.codes.registries.RegistryTechs.SUMMONTABLECRAFT;
...
public class SummoningTableDuo extends CraftingStationObject
{
    ...
    {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/crafting/summoningtableduo");
    }
    ...
    {
        return new CraftingStationUpgrade(ObjectRegistry.getObject("demonicsummoningtableduo"), new Ingredient("demonicbar", 5));
    }
    ...
    public static void registerSummoningTable()
    {
        SummoningTableDuo o1 = new SummoningTableDuo();
        SummoningTableDuo2 o2 = new SummoningTableDuo2();
        int i1 = ObjectRegistry.registerObject("summoningtableduo", o1, 25.0F, true);
        o1.counterID = ObjectRegistry.registerObject("summoningtableduo2", o2, 0.0F, false);
        o2.counterID = i1;
    }
