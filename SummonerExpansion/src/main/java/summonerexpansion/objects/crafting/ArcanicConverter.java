...
public class ArcanicConverter extends StaticMultiObject implements SettlementWorkstationObject
{
    ...
    {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/crafting/arcanicconverter");
    }
    ...
    public static void registerArcanicConverter(String texturePath, boolean isObtainable, boolean isObtainableInCreative)
    {
        int[] ids = new int[2];
