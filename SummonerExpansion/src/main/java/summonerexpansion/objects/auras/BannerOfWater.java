...
public class BannerOfWater extends GameObject
{
    ...
    {
        return GameTexture.fromFile("items/banners/" + this.getStringID());
    }

    public void loadTextures()
    {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/areas/" + getStringID());
    }
    ...
    public java.util.List<ObjectHoverHitbox> getHoverHitboxes(Level level, int layerID, int tileX, int tileY)
    {
