...
public class SummoningTableDuo extends CraftingStationObject
{
    ...
    {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/summoningtableduo");
    }
    ...
    public static int[] registerSummoningTable()
    {
        ...
        int i2 = ObjectRegistry.registerObject("summoningtableduo2", o2, 0.0F, false);
        o1.counterID = i2;
        o2.counterID = i1;
