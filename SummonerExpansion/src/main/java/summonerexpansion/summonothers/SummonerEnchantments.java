...
public class SummonerEnchantments
{
    ...
    {
        definitive = registerSummonEnchantment("definitive", new ToolItemEnchantment(20, new ModifierValue(ToolItemModifiers.DAMAGE, 0.05F), new ModifierValue(ToolItemModifiers.SUMMONS_SPEED, 0.05F), new ModifierValue(ToolItemModifiers.SUMMONS_TARGET_RANGE, 0.05F), new ModifierValue(ToolItemModifiers.CRIT_CHANCE, 0.05F), new ModifierValue(ToolItemModifiers.ARMOR_PEN, 0.05F), new ModifierValue(ToolItemModifiers.ATTACK_SPEED, 0.05F)));
        ...
        unambiguous = registerSummonEnchantment("unambiguous", new ToolItemEnchantment(-10, new ModifierValue(ToolItemModifiers.DAMAGE, -0.20F), new ModifierValue(ToolItemModifiers.CRIT_CHANCE, 0.10F), new ModifierValue(ToolItemModifiers.ARMOR_PEN, 0.10F)));
        maniacal = registerSummonEnchantment("maniacal", new ToolItemEnchantment(0, new ModifierValue(ToolItemModifiers.DAMAGE, 0.25F), new ModifierValue(ToolItemModifiers.CRIT_CHANCE, -0.25F), new ModifierValue(ToolItemModifiers.ARMOR_PEN, -0.10F)));
        ...
        feral = registerSummonEnchantment("feral", new ToolItemEnchantment(0, new ModifierValue(ToolItemModifiers.SUMMONS_SPEED, 0.30F), new ModifierValue(ToolItemModifiers.ARMOR_PEN, 0.05F)));
