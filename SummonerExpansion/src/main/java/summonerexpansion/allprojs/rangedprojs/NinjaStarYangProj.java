package summonerexpansion.allprojs.rangedprojs;
...
public class NinjaStarYangProj extends Projectile implements RicochetableProjectile
{
    public NinjaStarYangProj() {
    }

    public NinjaStarYangProj(float x, float y, float targetX, float targetY, float speed, GameDamage damage, Mob owner)
    {
        this.x = x;
        this.y = y;
    ...
    public Trail getTrail() {
        return new Trail(this, this.getLevel(), new Color(255, 255, 255), 14.0F, 250, 18.0F);
    }
