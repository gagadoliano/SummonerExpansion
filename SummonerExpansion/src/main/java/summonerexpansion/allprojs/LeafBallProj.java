...
public class LeafBallProj extends Projectile
{
    ...
    public void doHitLogic(Mob mob, LevelObjectHit object, float x, float y)
    {
        ...
        if (this.isServer())
        {
            if (mob != null)
            {
                ActiveBuff ab = new ActiveBuff("ivypoison", mob, 10.0F, this.getOwner());
                mob.addBuff(ab, true);
            }
        }
    }
    ...
    public Trail getTrail() {
        return new Trail(this, this.getLevel(), new Color(55, 129, 89), 12.0F, 500, 18.0F);
    }
