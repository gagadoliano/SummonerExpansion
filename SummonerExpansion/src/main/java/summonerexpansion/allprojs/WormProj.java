...
public class WormProj extends FollowingProjectile
{
    ...
    public void doHitLogic(Mob mob, LevelObjectHit object, float x, float y)
    {
        ...
        if (mob != null && this.isServer())
        {
            ...
            {
                getFirstPlayerOwner().serverFollowersManager.addFollower("summonedfishminion", mobFish, FollowPosition.PYRAMID, "summonedmob", 1.0F, (p) -> {return 3;}, (BiConsumer)null, false);
