...
public class SunflowerSentryT5 extends SunflowerSentry implements OEVicinityBuff
{
    public int flowerRange = 1200;

    public SunflowerSentryT5()
    {
        super();
    }
    ...
    {
        return new Buff[]{BuffRegistry.getBuff("sunflowerbufft5")};
    }
