...
public class GolemTopazMinion extends AttackingFollowingMob
{
        ...
        this.ai = new BehaviourTreeAI(this, new PlayerFollowerChaserAI<GolemTopazMinion>(600, 600, true, false, 900, 80)
        {
            public boolean attackTarget(GolemTopazMinion mob, Mob target)
            {
                if (mob.canAttack())
                {
                    ...
                    Projectile projectile = ProjectileRegistry.getProjectile("topazgolemswirl", mob.getLevel(), mob.x, mob.y, target.x, target.y, 80.0F, 600, summonDamage, mob);
