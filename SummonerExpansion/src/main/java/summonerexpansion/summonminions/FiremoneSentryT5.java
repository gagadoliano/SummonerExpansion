...
public class FiremoneSentryT5 extends FiremoneSentry implements OEVicinityBuff
{
    public int flowerRange = 1200;

    public FiremoneSentryT5()
    {
        super();
    }
    ...
    {
        return new Buff[]{BuffRegistry.getBuff("firemonebufft5")};
    }
