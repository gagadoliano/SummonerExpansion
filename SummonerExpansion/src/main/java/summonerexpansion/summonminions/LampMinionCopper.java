...
public class LampMinionCopper extends FlyingAttackingFollowingMob
{
    ...
    {
        super.init();
        ai = new BehaviourTreeAI<>(this, new PlayerFlyingFollowerCollisionChaserAI(200, (GameDamage)null, 15, 500, 640, 64), new FlyingAIMover());
    }
