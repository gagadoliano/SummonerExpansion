        ...
        this.ai = new BehaviourTreeAI(this, new PlayerFollowerChaserAI<GolemRubyMinion>(600, 600, true, false, 900, 80)
        {
            public boolean attackTarget(GolemRubyMinion mob, Mob target)
            {
                if (mob.canAttack())
                {
                    ...
                    Projectile projectile = ProjectileRegistry.getProjectile("crystalminionproj", mob.getLevel(), mob.x, mob.y, target.x, target.y, 80.0F, 600, GolemRubyMinion.this.summonDamage, mob);
