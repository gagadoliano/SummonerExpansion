...
public class SpiderBrideMinion extends AttackingFollowingMob
{
    public static GameTexture texture;
    public int lifeTime = 0;

    public SpiderBrideMinion()
    {
        super(10);
        setSpeed(30.0F);
        setFriction(3.0F);
    ...
    {
        super.init();
        this.ai = new BehaviourTreeAI<>(this, new PlayerFollowerChaserAI<SpiderBrideMinion>(600, 300, true, false, 900, 100)
        {
            public boolean attackTarget(SpiderBrideMinion mob, Mob target)
            {
                if (mob.canAttack())
                {
